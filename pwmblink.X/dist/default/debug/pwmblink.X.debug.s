...
; #config settings
	...
	config WRTAPP = "OFF"
	config CP = "OFF"
	file	"dist/default/debug\pwmblink.X.debug.s"
	line	#
...
l1523:
;main.c: 54:     SYSTEM_Initialize();
	call	_SYSTEM_Initialize	;wreg free
	line	55
	
l1525:
;main.c: 55:     PWM1_16BIT_WritePeriodRegister(periodCountTop);
	movlw	high(064h)
...
l1527:
;main.c: 56:     TMR0_PeriodMatchCallbackRegister(PWM_DutyCycleSetPercentage_Slice1);
...
i2l1485:
;main.c: 44:     uint16_t PWM_DytyCyclePercentage = j;
...
i2l1487:
;main.c: 45:     PWM1_16BIT_SetSlice1Output1DutyCycleRegister(PWM_DytyCyclePercentage);
...
i2l1489:
;main.c: 46:     PWM1_16BIT_LoadBufferRegisters();
